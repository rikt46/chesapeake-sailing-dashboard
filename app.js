...
// Rain severity, SCA force/apply, tide phase, wind opposition, water
// level anomaly, and depth windows all live in src/recommendation.js
// (imported above).
  ...
  // ========== SAIL RECOMMENDATION ==========
  // assessDay, computeAllRecommendations live in src/recommendation.js
  // (imported above).
  ...
  // ========== CHARTS ==========
  // Chart.js wrappers (getChartColors, renderWindChart, renderTideChart)
  // and the windChartInstance / tideChartInstance state live in
  // src/charts.js (imported above).
